...
def send_welcome_email(to: str, name: str, api_key: str, account_id: str = None) -> bool:
    subject = "Welcome to TradePattrnly — Your EA & Setup Guide"
    account_id_section = f"""
      <!-- Account ID -->
      <h2>Your Account ID</h2>
      <p>This links your MT5 to your journal account:</p>
      <div class="api-key">{account_id}</div>
""" if account_id else ""
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <!-- API Key -->
      <h2>Your API Key</h2>
      <p>Keep this safe — it authenticates your MT5 connection:</p>
      ...
      <div class="step">
        ...
        <p>Drag the EA onto any chart, then set these two parameters:</p>
        <br>
        <p><strong style="color:#E8ECF4">API_KEY</strong> = your API key above</p>
        <p><strong style="color:#E8ECF4">ACCOUNT_ID</strong> = your account ID above</p>
      </div>
